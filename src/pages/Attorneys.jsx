...
const attorneys = [
  ...
  },
  {
    name: "Sophia Lee",
    image:
      "https://images.unsplash.com/photo-1598550874175-4d0ef436c909?auto=format&fit=crop&w=800&q=80",
  ...
  return (
    <Box sx={{ minHeight: "100vh", pt: 0 }}>
      ...
      <Container maxWidth="md" sx={{ textAlign: "center", mb: 6 }}>
        ...
        >
          Our team of experienced attorneys is dedicated to providing top-tier
          legal representation. With a wealth of knowledge across multiple
          practice areas, we are committed to protecting your rights and
                    ...
                    {[
                      {
                        ...
                        url: attorney.social.facebook,
                      },
                      {
                        icon: <Linkedin size={20} />,
                        url: attorney.social.linkedin,
                      },
                      {
                        icon: <Instagram size={20} />,
                        url: attorney.social.instagram,
                      },
                      {
                        icon: <Twitter size={20} />,
                        url: attorney.social.twitter,
                      },
                    ].map((social, idx) => (
                      <IconButton
                        key={idx}
